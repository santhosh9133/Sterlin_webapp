...
const AddDesignation = () => {
        ...
        try {
            ...
            if (data.success) {
                ...
                setTimeout(() => {
                    ...
                    window.location.reload(); // Refresh to show new designation
                }, 1500);
            } else {
    ...
    return (
        <>
            <div className="modal fade" id="add-designation">
                                            ...
                                            <div className="input-blocks m-0">
                                                <div className="status-toggle modal-status d-flex justify-content-between align-items-center">
                                                    ...
                                                    <input
                                                        ...
                                                        className="check"
                                                    />
                                                    <label htmlFor="designationStatus" className="checktoggle"></label>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
