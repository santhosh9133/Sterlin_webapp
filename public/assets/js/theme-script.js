...
<div class="sidebar-contact ">
    ...
    // Function to wait for sidebar element to be available
    ...
    function waitForSidebar(callback) {
        ...
        if (sidebarElement) {
            ...
            setTimeout(() => waitForSidebar(callback), 100);
        }
    }
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        // Wait for React components to mount before initializing theme
        waitForSidebar(function() {
            console.log('Sidebar found, initializing theme...');
        });
        ...
        function setThemeAndSidebarTheme(theme, sidebarTheme, color, layout, topbar, width) {
            const sidebarElement = document.querySelector('.sidebar'); // Get sidebar element each time
